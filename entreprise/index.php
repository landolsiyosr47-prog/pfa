...
<head>
    ...
    <title>RéEmploi BTP — Entreprises</title>
    ...
    <style>
        ...
        .btn-inscrire:hover { background-color: var(--dark-green) !important; transform: translateY(-2px); }
        ...
        th { text-align: left; padding: 15px; color: var(--primary-green); border-bottom: 2px solid var(--soft-green); text-transform: uppercase; font-size: 0.85rem; letter-spacing: 0.5px; }
...
<body>
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="ajouter_entreprise.php" class="btn-inscrire">+ Ajouter Entreprise</a></li>
        </ul>
    </nav>
                ...
                <tbody>
                    ...
                    if ($result && $result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            echo "<tr>
                            <td style='color: #888;'>#".$row['id_entrep']."</td>
                            <td>".$row['id_user']."</td>
                            <td style='font-weight: 600;'>".htmlspecialchars($row['nom_entrep'])."</td>
                            <td>".htmlspecialchars($row['secteur_activite_entrep'])."</td>
                            <td><code>".htmlspecialchars($row['matricule_fiscale_entrep'])."</code></td>
                            <td class='actions'>
                                <a href='modifier_entreprise.php?id=".$row['id_entrep']."' class='btn-edit'>Modifier</a>
                                <a href='supprimer_entreprise.php?id=".$row['id_entrep']."' class='btn-delete' onclick='return confirm(\"Supprimer cette entreprise ?\")'>Supprimer</a>
                            </td>
                            </tr>";
                        }
                    } else {
                        echo "<tr><td colspan='6' style='text-align:center; padding: 30px;'>Aucune entreprise enregistrée.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
    ...
    <footer class="footer">
        ...
        <div class="footer-bottom">
            <p>© 2026 RéEmploi BTP · Panel Administration · <a href="#" style="color:rgba(255,255,255,0.5)">Mentions légales</a></p>
        </div>
    </footer>
</body>
</html>