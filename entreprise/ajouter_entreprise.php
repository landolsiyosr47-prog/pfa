...
<head>
    ...
    <title>RéEmploi BTP — Ajouter Entreprise</title>
...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="index.php" class="btn-inscrire">Liste Entreprises</a></li>
        </ul>
    </nav>
    ...
    <main class="main-content">
        <div class="form-card">
            ...
            <form action="insert_entreprise.php" method="POST">
                ...
                <input type="number" name="id_user" placeholder="ID du responsable" required>

                <span class="label-title">Nom de l'entreprise</span>
                <input type="text" name="nom" placeholder="Ex: Batipro SARL" required>

                <span class="label-title">Secteur d'activité</span>
                <input type="text" name="secteur" placeholder="Ex: Menuiserie, Maçonnerie">

                <span class="label-title">Matricule fiscal</span>
                <input type="text" name="matricule" placeholder="Ex: 1234567/A/B/C/000" required>
