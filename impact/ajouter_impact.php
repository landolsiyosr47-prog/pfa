...
<head>
    ...
    <title>RéEmploi BTP — Ajouter un Impact</title>
...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="index.php" class="btn-inscrire">← Retour liste</a></li>
        </ul>
    </nav>
    ...
    <main class="main-content">
        <div class="form-card">
            ...
            <form action="insert_impact.php" method="POST">
                
                <span class="label-title">Déchets évités (kg)</span>
                <input type="number" step="0.01" name="dechets" placeholder="Ex: 150.50" required>

                <span class="label-title">CO₂ économisé (kg)</span>
                <input type="number" step="0.01" name="co2" placeholder="Ex: 45.20" required>

                <span class="label-title">Date et Heure (Automatique)</span>
                <input type="datetime-local" name="date" 
                       value="<?php echo date('Y-m-d\TH:i'); ?>" 
                       readonly required>

                <button type="submit">Valider l'impact écologique</button>
            </form>
        </div>
    </main>
