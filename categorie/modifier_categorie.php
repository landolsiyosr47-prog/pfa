...
<head>
    ...
    <title>RéEmploi BTP — Modifier Catégorie</title>
    ...
    <style>
        ...
        h2 { font-family: 'Playfair Display', serif; color: var(--dark-green); text-align: center; margin-bottom: 10px; font-size: 2rem; }
        .id-badge { text-align: center; color: #666; margin-bottom: 30px; font-size: 0.85rem; font-weight: 700; opacity: 0.6; }
        ...
        input[type="text"]:focus { outline: none; background-color: var(--white); border-color: var(--primary-green); box-shadow: 0 5px 15px rgba(61, 140, 98, 0.1); }

        button[type="submit"] {
            width: 100%; background-color: var(--primary-green); color: white;
            padding: 16px; border: none; border-radius: 50px; font-weight: 700; cursor: pointer; transition: 0.3s; font-size: 1rem;
        }
...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="index.php" style="color: var(--primary-green);">← Annuler la modification</a></li>
        </ul>
    </nav>
    ...
    <main class="main-content">
        <div class="form-card">
            ...
            <div class="id-badge">ID CATÉGORIE : #<?php echo $row['id_categorie']; ?></div>
            
            <form action="update_categorie.php" method="POST">
                <!-- Champ masqué pour envoyer l'ID -->
                <input type="hidden" name="id" value="<?php echo $row['id_categorie']; ?>">

                <span class="label-title">Nom de la catégorie</span>
                <input type="text" name="nom_categorie" value="<?php echo $row['nom_categorie']; ?>" required>
    ...
    <footer class="footer">
        <div class="footer-inner">
            <div class="footer-col">
                ...
                <p style="font-size: 0.9rem; opacity: 0.8;">Mise à jour des paramètres du catalogue de matériaux.</p>
            </div>
            <div class="footer-col">
                <h5>Navigation</h5>
                <ul>
        ...
        <div class="footer-bottom"><p>© 2026 RéEmploi BTP · Panel d'Administration</p></div>
    </footer>
