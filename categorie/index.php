...
<head>
    ...
    <title>RéEmploi BTP — Gestion des Catégories</title>
...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="ajouter_categorie.php" class="btn-inscrire">+ Ajouter Catégorie</a></li>
        </ul>
    </nav>
                ...
                <tbody>
                    ...
                    if ($result && $result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            echo "<tr>";
                            echo "<td style='color: #888;'>#" . $row['id_categorie'] . "</td>";
                            echo "<td><strong style='font-size: 1rem;'>" . htmlspecialchars($row['nom_categorie']) . "</strong></td>";
                            echo '<td>
                                    <a href="modifier_categorie.php?id=' . $row['id_categorie'] . '" class="btn-action edit">Modifier</a>
                                    <a href="supprimer_categorie.php?id=' . $row['id_categorie'] . '" class="btn-action delete" onclick="return confirm(\'Supprimer cette catégorie ?\')">Supprimer</a>
                                  </td>';
                            echo "</tr>";
                        }
                    } else {
                        echo "<tr><td colspan='3' style='text-align:center; padding: 30px;'>Aucune catégorie trouvée.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
