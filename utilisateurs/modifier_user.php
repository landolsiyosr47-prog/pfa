...
<head>
    ...
    <title>RéEmploi BTP — Modifier Profil</title>
    ...
    <main class="main-content">
        <div class="form-card">
            ...
            <form action="update_user.php" method="POST">
                ...
                <input type="text" name="nom" value="<?php echo $row['nom_user']; ?>">

                <span class="label-title">Prénom</span>
                <input type="text" name="prenom" value="<?php echo $row['prenom_user']; ?>">

                <span class="label-title">Email</span>
                <input type="email" name="email" value="<?php echo $row['email_user']; ?>">

                <span class="label-title">Type</span>
                <select name="type">
                    <option value="entreprise" <?php if($row['type_user']=='entreprise') echo 'selected'; ?>>Entreprise</option>
                    <option value="artisan" <?php if($row['type_user']=='artisan') echo 'selected'; ?>>Artisan</option>
                    <option value="particulier" <?php if($row['type_user']=='particulier') echo 'selected'; ?>>Particulier</option>
                </select>

                <span class="label-title">Ville</span>
                <input type="text" name="ville" value="<?php echo $row['ville_user']; ?>">
