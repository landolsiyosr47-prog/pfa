...
<head>
    ...
    <title>RéEmploi BTP — Modifier Message</title>
...
<body>
    ...
    <nav class="navbar">
        ...
        <a href="index.php" class="btn-retour">← Retour aux messages</a>
    </nav>
    ...
    <main class="main-content">
        <div class="form-card">
            ...
            <form action="update_message.php" method="POST">
                ...
                <span class="label-title">👤 Émetteur</span>
                <select name="uti_id_user">
                    <?php
                    $res = $conn->query("SELECT id_user, nom_user FROM UTILISATEUR");
                    while($r = $res->fetch_assoc()){
                        $selected = ($r['id_user'] == $row['uti_id_user']) ? "selected" : "";
                        echo "<option value='".$r['id_user']."' $selected>".htmlspecialchars($r['nom_user'])."</option>";
                    }
                    ?>
                </select>

                <span class="label-title">📩 Destinataire</span>
                <select name="id_user">
                    <?php
                ...
                <span class="label-title">💬 Contenu du message</span>
                <textarea name="contenu_message" required><?php echo htmlspecialchars($row['contenu_message']); ?></textarea>
