...
<head>
    ...
    <title>RéEmploi BTP — Ajouter un signalement</title>
...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="index.php" class="btn-list">Liste Signalements</a></li>
        </ul>
    </nav>
    ...
    <main class="main-content">
        <div class="form-card">
            ...
            <form action="insert_signalement.php" method="POST">
                
                <span class="label-title">ID Matériau</span>
                <input type="number" name="id_materiau" placeholder="Entrez l'ID du produit" required>

                <span class="label-title">ID Utilisateur</span>
                <input type="number" name="id_user" placeholder="Votre ID utilisateur" required>

                <span class="label-title">Motif du signalement</span>
                <textarea name="motif_signalement" placeholder="Décrivez le problème rencontré..." required></textarea>

                <span class="label-title">Date du constat</span>
                <input type="date" name="date_signalement" required>
    ...
    <footer class="footer">
        <div class="footer-inner">
            <div class="footer-col">
                ...
                <p style="font-size: 0.9rem; opacity: 0.8;">Sécurité et transparence pour le réemploi des matériaux.</p>
            </div>
            <div class="footer-col">
                <h5>Navigation</h5>
                <ul>
        ...
        <div class="footer-bottom">
            <p>© 2026 RéEmploi BTP · Panel Modération · <a href="#">Aide</a></p>
        </div>
    </footer>
